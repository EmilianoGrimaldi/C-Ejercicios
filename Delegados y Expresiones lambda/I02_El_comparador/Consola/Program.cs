...
namespace Consola
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //DelegadoComparacion delegadoComparacion = Comparar;
            /*/
        ...
        public static void Comparar(string str1, string str2, Func<string,string,int> criterio)
        {           
            if (criterio(str1, str2) > 0)
            {
                Console.WriteLine("El primer texto es mayor al segundo");
            }
            else if (criterio(str1, str2) < 0)
            {
